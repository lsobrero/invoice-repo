 ...
 */
@Entity
@Table(name = "ricezione")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ricezione implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("riceziones")
    ...
    public Ricezione idDocumento(String idDocumento) {
    ...
    public Ricezione dOAData(String dOAData) {
    ...
    public Ricezione numItem(String numItem) {
    ...
    public Ricezione codiceCommessaConvenzione(String codiceCommessaConvenzione) {
    ...
    public Ricezione codiceCUP(String codiceCUP) {
    ...
    public Ricezione codiceCIG(String codiceCIG) {
    ...
    public Ricezione fABody(FABody fABody) {
        this.fABody = fABody;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Ricezione)) {
            return false;
        }
        return id != null && id.equals(((Ricezione) o).id);
    }
