...
public class Convenzione implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("convenziones")
    ...
    public Convenzione idDocumento(String idDocumento) {
    ...
    public Convenzione dOAData(String dOAData) {
    ...
    public Convenzione numItem(String numItem) {
    ...
    public Convenzione codiceCommessaConvenzione(String codiceCommessaConvenzione) {
    ...
    public Convenzione codiceCUP(String codiceCUP) {
    ...
    public Convenzione codiceCIG(String codiceCIG) {
    ...
    public Convenzione fABody(FABody fABody) {
        this.fABody = fABody;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Convenzione)) {
            return false;
        }
        return id != null && id.equals(((Convenzione) o).id);
    }
