...
public class Contratto implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("contrattos")
    ...
    public Contratto idDocumento(String idDocumento) {
    ...
    public Contratto dOAData(String dOAData) {
    ...
    public Contratto numItem(String numItem) {
    ...
    public Contratto codiceCommessaConvenzione(String codiceCommessaConvenzione) {
    ...
    public Contratto codiceCUP(String codiceCUP) {
    ...
    public Contratto codiceCIG(String codiceCIG) {
    ...
    public Contratto fABody(FABody fABody) {
        this.fABody = fABody;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((Contratto) o).id);
    }
