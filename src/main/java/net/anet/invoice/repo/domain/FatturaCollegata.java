 ...
 */
@Entity
@Table(name = "fattura_collegata")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class FatturaCollegata implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("fatturaCollegatas")
    ...
    public FatturaCollegata idDocumento(String idDocumento) {
    ...
    public FatturaCollegata dOAData(String dOAData) {
    ...
    public FatturaCollegata numItem(String numItem) {
    ...
    public FatturaCollegata codiceCommessaConvenzione(String codiceCommessaConvenzione) {
    ...
    public FatturaCollegata codiceCUP(String codiceCUP) {
    ...
    public FatturaCollegata codiceCIG(String codiceCIG) {
    ...
    public FatturaCollegata fABody(FABody fABody) {
        this.fABody = fABody;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FatturaCollegata)) {
            return false;
        }
        return id != null && id.equals(((FatturaCollegata) o).id);
    }
